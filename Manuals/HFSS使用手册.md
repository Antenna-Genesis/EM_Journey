...
0. ## 通用设置
      ...
      2. HFSS是频域求解器，不擅长做宽带计算，进行宽带仿真时使扫频频带尽可能窄，一般不宜超过30%带宽。另外，做相对宽一点频带的仿真时，建议使用离散模式，可以使得远场计算更加准确。
         ...
         ![discrete](file://F:/GitHub/EM_Journey/Manuals/HFSS%E4%BD%BF%E7%94%A8%E6%89%8B%E5%86%8C.assets/181329_0e733008_9257194.png?lastModify=1623729288)
      ...
      5. 双层空气盒子。尽量设置两层空气盒子，其中，外层盒子与天线的距离要约等于1/4中心频率波长，用于吸收电磁波（设置为辐射边界），从而模拟天线放在自由空间的情况；内层尽量接近天线，用作求解方向图时候的近场-远场变换。内边界的表面设置为一个facelist，之后计算远场的时候，选这个facelist作为近场源。
