...
NotebookDataLength[     82293,       1698]
NotebookOptionsPosition[     55434,       1113]
NotebookOutlinePosition[     81691,       1674]
CellTagsIndexPosition[     81580,       1668]
WindowTitle->Gauss Law in Electrostatics
WindowFrame->Normal*)
...
Cell["Gauss Law in Electrostatics", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`figure$$ = "sphere", $CellContext`x$$ = 0, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`figure$$], "sphere"}, {"sphere", "cube"}}, {{
       Hold[$CellContext`x$$], 0, "move"}, 0, 1.5}}, Typeset`size$$ = {
    360., {178., 182.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`figure$806$$ = 
    False, $CellContext`x$807$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`figure$$ = "sphere", $CellContext`x$$ = 0},
       "ControllerVariables" :> {
        Hold[$CellContext`figure$$, $CellContext`figure$806$$, False], 
        Hold[$CellContext`x$$, $CellContext`x$807$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Show[
        VectorPlot3D[{$CellContext`x$$, $CellContext`y, $CellContext`z}, \
{$CellContext`x$$, -1, 2.5}, {$CellContext`y, -1, 1}, {$CellContext`z, -1, 1},
          VectorColorFunction -> "Rainbow", VectorScale -> 0.075], 
        Graphics3D[{
          PointSize[0.015], 
          Point[{0, 0, 0}], 
          Opacity[0.5], 
          Translate[
           If[$CellContext`figure$$ == "sphere", 
            Sphere[], 
            Cuboid[{-1, -1, -1}, {1, 1, 1}]], {$CellContext`x$$, 0, 0}]}], 
        Boxed -> False, Axes -> False, BoxRatios -> {3.5, 2, 2}, 
        PlotRange -> {{-1, 2.5}, {-1, 1}, {-1, 1}}, SphericalRegion -> True], 
      "Specifications" :> {{{$CellContext`figure$$, "sphere"}, {
         "sphere", "cube"}}, {{$CellContext`x$$, 0, "move"}, 0, 1.5}}, 
      "Options" :> {SynchronousUpdating -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{405., {234., 239.}},
...
Cell["\<\
The net electric flux through any closed surface is proportional to the \
charge enclosed by the surface (in this case a sphere or a cube). Notice that \
when the charge is inside the surface, all vectors representing the electric \
flux point outward, but when the surface is moved and no longer encloses the \
charge, the flux entering one side exits the opposite side and the net flux \
equals zero.\
\>", "ManipulateCaption",
 CellID->1530304550],

Cell["\<\
This law was formulated by Carl Friedrich Gauss in 1835 and it is the basis \
for the first of Maxwell's equations.\
\>", "ManipulateCaption",
 CellID->1564415378],
...
Cell[TextData[{
 "The law can be expressed in differential form as ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"\[Del]", 
 ...
 " is the divergence of the electric field, ",
 Cell[BoxData[
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["\[Epsilon]", "0"], TraditionalForm]], "InlineMath"],
 " is the permittivity of free space. This can be rewritten in integral form \
as ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"\[ContourIntegral]", 
     RowBox[{
      RowBox[{
       StyleBox["E",
        FontWeight->"Bold",
        FontSlant->"Plain"], "\[CenterDot]", "d"}], "\[InvisibleSpace]", 
      StyleBox["A",
       FontWeight->"Bold",
       FontSlant->"Plain"]}]}], "=", 
    RowBox[{
  ...
  FormBox[
   RowBox[{"d", "\[InvisibleSpace]", 
    StyleBox["A",
     FontWeight->"Bold",
     FontSlant->"Plain"]}], TraditionalForm]], "InlineMath"],
 " is the differential element of area in the integration over the closed \
surface and ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["q", "enc"], TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 ButtonBox["Charge",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Charge.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/Charge.html"],
 " (",
...
Cell[TextData[{
 ButtonBox["Charge Density",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/ChargeDensity.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/ChargeDensity.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Permittivity of Free Space",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/PermittivityofFreeSpace.\
html"], None},
  ButtonNote->
...
Cell[TextData[{
 ButtonBox["Karl Friedrich Gauss",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/biography/Gauss.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/biography/Gauss.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Maxwell Equations",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/MaxwellEquations.html"], 
    None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/MaxwellEquations.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
GaussLawInElectrostatics&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/GaussLawInElectrostatics/\
GaussLawInElectrostatics-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Gauss Law in Electrostatics",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/GaussLawInElectrostatics/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/GaussLawInElectrostatics/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/GaussLawInElectrostatics/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/GaussLawInElectrostatics/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/GaussLawInElectrostatics/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[38794, 670, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39055, 679, 4103, 91, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54612, 1088, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81293, 1657},
 {"Copyright", 81488, 1662}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1276, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35607, 600, 48, 0, 70, "DemoTitle"],
Cell[35658, 602, 2494, 50, 70, "Output",
 CellID->1550524699],
Cell[38155, 654, 460, 8, 70, "ManipulateCaption",
 CellID->1530304550],
Cell[38618, 664, 173, 4, 70, "ManipulateCaption",
 CellID->1564415378],
Cell[38794, 670, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39055, 679, 4103, 91, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43161, 772, 33, 0, 70, "DetailsSection"],
Cell[43197, 774, 1745, 58, 70, "DetailNotes",
 CellID->1055872881],
Cell[44945, 834, 44, 0, 70, "RelatedLinksSection"],
Cell[44992, 836, 476, 15, 70, "RelatedLinks",
 CellID->1885979627],
Cell[45471, 853, 498, 15, 70, "RelatedLinks",
 CellID->1210819428],
Cell[45972, 870, 536, 17, 70, "RelatedLinks",
 CellID->1486967825],
Cell[46511, 889, 497, 15, 70, "RelatedLinks",
 CellID->931205592],
Cell[47011, 906, 469, 15, 70, "RelatedLinks",
 CellID->219417967],
Cell[47483, 923, 491, 15, 70, "RelatedLinks",
 CellID->528349470],
Cell[47977, 940, 512, 16, 70, "RelatedLinks",
 CellID->1590329099],
Cell[48492, 958, 4811, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53306, 1049, 45, 0, 70, "CitationSection"],
Cell[53354, 1051, 330, 10, 70, "Author"],
Cell[53687, 1063, 922, 23, 70, "Citations"],
Cell[54612, 1088, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature jQEnh6Y5luFJNv7KQ8R0u3yi *)
