...
NotebookDataLength[     77669,       1539]
NotebookOptionsPosition[     50689,        960]
NotebookOutlinePosition[     76936,       1521]
CellTagsIndexPosition[     76825,       1515]
WindowTitle->Electromagnetic Wave
WindowFrame->Normal*)
...
Cell["Electromagnetic Wave", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 3, $CellContext`t$$ = 0.6, 
      ...
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        ParametricPlot3D[{$CellContext`t0 + $CellContext`t$$, 0, 
          Sin[$CellContext`t0]}, {$CellContext`t0, -$CellContext`t$$, 
          2 Pi $CellContext`n$$ - $CellContext`t$$}], 
        ParametricPlot3D[{$CellContext`t0 + $CellContext`t$$, -
          Sin[$CellContext`t0], 0}, {$CellContext`t0, -$CellContext`t$$, 
          2 Pi $CellContext`n$$ - $CellContext`t$$}], 
        Graphics3D[{
          Text["E", {0, 0.2, 1}], 
          Text["B", {0, -1.2, 0}], 
          ...
          Polygon[{{0, -1, 0}, {0, 1, 0}, {2 Pi $CellContext`n$$, 1, 0}, {
            2 Pi $CellContext`n$$, -1, 0}}], 
          
          Polygon[{{0, 0, 1}, {0, 0, -1}, {2 Pi $CellContext`n$$, 0, -1}, {
            2 Pi $CellContext`n$$, 0, 1}}], 
          Arrowheads[0.01], 
          Table[
           Arrow[{{
              ...
              Mod[$CellContext`d + $CellContext`t$$, 2 Pi $CellContext`n$$], 
              0, 
              Sin[$CellContext`d]}}], {$CellContext`d, $CellContext`t$$, 
            2 Pi $CellContext`n$$ + $CellContext`t$$, Pi/3}], 
          Table[
           Arrow[{{
              Mod[$CellContext`d + $CellContext`t$$, 2 Pi $CellContext`n$$], 
              0, 0}, {
              Mod[$CellContext`d + $CellContext`t$$, 2 Pi $CellContext`n$$], -
              Sin[$CellContext`d], 0}}], {$CellContext`d, $CellContext`t$$, 
            2 Pi $CellContext`n$$ + $CellContext`t$$, Pi/3}], 
          Arrowheads[0.03], Red, 
...
Cell[TextData[{
 "This representation of a plane\[Hyphen]polarized sinusoidal electromagnetic \
wave shows its perpendicular electric and magnetic components. In a vacuum, \
such a wave travels at the speed of light, ",
 Cell[BoxData[
...
Cell[TextData[{
 ButtonBox["Wave",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Wave.html"], None}],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ElectromagneticWave&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ElectromagneticWave/ElectromagneticWave-\
...
Cell[TextData[{
 ...
 ButtonBox["Electromagnetic Wave",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ElectromagneticWave/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ElectromagneticWave/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/ElectromagneticWave/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ElectromagneticWave/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ElectromagneticWave/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39194, 684, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39455, 693, 3558, 78, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49867, 935, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 76539, 1504},
 {"Copyright", 76734, 1509}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[584, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34915, 590, 41, 0, 70, "DemoTitle"],
Cell[34959, 592, 3915, 81, 70, "Output",
 CellID->20741476],
Cell[38877, 675, 314, 7, 70, "ManipulateCaption"],
Cell[39194, 684, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39455, 693, 3558, 78, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43016, 773, 44, 0, 70, "RelatedLinksSection"],
Cell[43063, 775, 438, 15, 70, "RelatedLinks",
 CellID->968607469],
Cell[43504, 792, 402, 14, 70, "RelatedLinks",
 CellID->992870480],
Cell[43909, 808, 4796, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[48708, 899, 45, 0, 70, "CitationSection"],
Cell[48756, 901, 778, 20, 70, "Citations"],
Cell[49537, 923, 327, 10, 70, "Author"],
Cell[49867, 935, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature wSqwxCDVKL37TumBGgXdW#KM *)
