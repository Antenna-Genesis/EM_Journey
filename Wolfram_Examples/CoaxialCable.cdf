...
NotebookDataLength[     83331,       1688]
NotebookOptionsPosition[     56847,       1114]
NotebookOutlinePosition[     83091,       1675]
CellTagsIndexPosition[     82980,       1669]
WindowTitle->Coaxial Cable
WindowFrame->Normal*)
...
Cell["Coaxial Cable", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`r$$ = 0.2, $CellContext`\[Theta]$$ = 2.75, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`r$$], 0.2}, 0., 0.4}, {{
       Hold[$CellContext`\[Theta]$$], 2.75}, 0., 6.283185307179586}}, 
    Typeset`size$$ = {500., {216.84375, 222.15625}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`r$106237$$ = 0, $CellContext`\[Theta]$106238$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`r$$ = 0.2, $CellContext`\[Theta]$$ = 2.75},
       "ControllerVariables" :> {
        Hold[$CellContext`r$$, $CellContext`r$106237$$, 0], 
        Hold[$CellContext`\[Theta]$$, $CellContext`\[Theta]$106238$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Text[
          Row[{
            Style["L", Italic], " = ", (0.02/(2 Pi)) TraditionalForm[
              Log[$CellContext`b/$CellContext`a]], ", ", 
            Style["U", Italic], " = ", (0.02/(4 Pi)) TraditionalForm[
              Log[$CellContext`b/$CellContext`a]]}]], 
         Show[{
           ParametricPlot3D[{{
              Cos[$CellContext`u], 
              Sin[$CellContext`u], 2 $CellContext`v}, {
             0.9 Cos[$CellContext`u], 0.9 Sin[$CellContext`u], 
              2 $CellContext`v}, {
             0.4 Cos[$CellContext`u], 0.4 Sin[$CellContext`u], 
              2 $CellContext`v}, {
             0.3 Cos[$CellContext`u], 0.3 Sin[$CellContext`u], 
              2 $CellContext`v}}, {$CellContext`u, 0, 2 Pi}, {$CellContext`v, 
             0, 1}, Mesh -> None, Boxed -> False, Axes -> False, PlotStyle -> {
              Opacity[0.3]}], 
           
           ParametricPlot3D[{{$CellContext`v 
              Cos[$CellContext`u], $CellContext`v Sin[$CellContext`u], 
              2}, {$CellContext`v Cos[$CellContext`u], $CellContext`v 
              Sin[$CellContext`u], 0}}, {$CellContext`u, 0, 2 
             Pi}, {$CellContext`v, 0.3, 0.4}, Mesh -> None, Boxed -> False, 
           ...
           ParametricPlot3D[{{$CellContext`v 
              ...
              2}, {$CellContext`v Cos[$CellContext`u], $CellContext`v 
              Sin[$CellContext`u], 0}}, {$CellContext`u, 0, 2 
             Pi}, {$CellContext`v, 0.9, 1}, Mesh -> None, Boxed -> False, 
            Axes -> False, PlotStyle -> {
              Opacity[0.3]}], 
           Graphics3D[{
             Rotate[
              Arrow[{{0, 0, 2}, {0, 0.4, 2}}], Pi/3, {0, 0, 1}], 
             Text[
              Style["I", Italic], {0, -0.2, 2.7}], 
             Text[
              Style["a", Italic], {-0.1, -0.1, 2.}], 
             Arrow[{{0, 0, 2}, {0, 1, 2}}], 
             Text[
              Style["b", Italic], {0.1, 0.4, 2.}], 
             Arrow[{{0, 0, 2}, {0, 0, 3}}], 
             Text[
              Style["I", Italic], {-0.7, -1.1, 1.5}], 
             Text[
              Style["l", Italic], {0.7, 1., 1}], 
             Arrow[{{-0.6, -1.1, 1.5}, {-0.6, -1.1, 0.5}}], Cyan, 
             Opacity[0.3], 
             Rotate[{
               Polygon[{{0, 0.4, 0}, {0, 0.4, 2}, {0, 0.9, 2}, {0, 0.9, 0}}], 
               
               Polygon[{{0, 0.4 + $CellContext`r$$, 0}, {
                 0, 0.4 + $CellContext`r$$, 2}, {
                 0, 0.5 + $CellContext`r$$, 2}, {
                 0, 0.5 + $CellContext`r$$, 0}}], Black, 
               
               Arrow[{{
                 0, 0.45 + $CellContext`r$$, 1}, {-0.5, 
                  0.45 + $CellContext`r$$, 1}}], 
               Text[
                Style[
                "B", Italic], {-0.6, 0.45 + $CellContext`r$$, 
                 1}]}, $CellContext`\[Theta]$$, {0, 0, 1}]}]}, PlotRange -> 
          All, SphericalRegion -> True, ImageSize -> {500, 410}]}, Alignment -> 
        Center], 
      "Specifications" :> {{{$CellContext`r$$, 0.2}, 0., 
         0.4}, {{$CellContext`\[Theta]$$, 2.75}, 0., 6.283185307179586}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {276., 281.}},
...
Cell[TextData[{
 "Coaxial cables are used to connect several types of electrical components. \
A coaxial cable consists of two thin concentric cylindrical conducting \
shells, here with radii ",
 Cell[BoxData[
 ...
 ". The conducting shells carry equal currents ",
 Cell[BoxData[
  FormBox["I", TraditionalForm]], "InlineMath"],
 " in opposite directions. There is a magnetic field in the volume between \
the shells that is always perpendicular to the area of the rectangle, shown \
in cyan (see it by rotating using the control for the angle ",
 Cell[BoxData[
  FormBox["\[Theta]", TraditionalForm]], "InlineMath"],
 "). The magnetic flux, self-inductance ",
 Cell[BoxData[
  FormBox["L", TraditionalForm]], "InlineMath"],
 ", and total stored energy ",
 Cell[BoxData[
  FormBox["U", TraditionalForm]], "InlineMath"],
 " can be calculated by integrating each differential strip along the radius ",
 Cell[BoxData[
   ...
   RowBox[{"L", " ", "=", 
    RowBox[{
     FractionBox[
      ...
      RowBox[{"2", "\[Pi]"}]], " ", 
     RowBox[{"ln", "(", 
      FractionBox["b", "a"], ")"}]}]}], TraditionalForm]], "InlineMath"],
 " and the total stored energy is ",
 Cell[BoxData[
  FormBox[
   RowBox[{"U", "=", 
    RowBox[{
...
Cell[TextData[{
 ButtonBox["Permeability of Free Space",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/PermeabilityofFreeSpace.\
html"], None},
  ButtonNote->
...
Cell[TextData[{
 ButtonBox["Self Inductance",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/SelfInductance.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/SelfInductance.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Magnetic Flux",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/MagneticFlux.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/MagneticFlux.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
CoaxialCable&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/CoaxialCable/CoaxialCable-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Coaxial Cable",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CoaxialCable/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CoaxialCable/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/CoaxialCable/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CoaxialCable/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CoaxialCable/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41779, 740, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[42040, 749, 5495, 119, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[56025, 1089, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82692, 1658},
 {"Copyright", 82888, 1663}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35630, 602, 4951, 104, 70, "Output",
 CellID->1669613484],
Cell[40584, 708, 1192, 30, 70, "ManipulateCaption"],
Cell[41779, 740, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42040, 749, 5495, 119, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[47538, 870, 33, 0, 70, "DetailsSection"],
Cell[47574, 872, 852, 30, 70, "DetailNotes",
 CellID->227116138],
Cell[48429, 904, 44, 0, 70, "RelatedLinksSection"],
Cell[48476, 906, 535, 17, 70, "RelatedLinks",
 CellID->402019041],
Cell[49014, 925, 500, 15, 70, "RelatedLinks",
 CellID->834853961],
Cell[49517, 942, 495, 15, 70, "RelatedLinks",
 CellID->1879856676],
Cell[50015, 959, 4775, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[54793, 1050, 45, 0, 70, "CitationSection"],
Cell[54841, 1052, 330, 10, 70, "Author"],
Cell[55174, 1064, 848, 23, 70, "Citations"],
Cell[56025, 1089, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature rQaSqk#51mbw4umo1AFFDrvT *)
