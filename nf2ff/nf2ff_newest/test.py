...
ax.plot(x_, Gain_C, 'k--', label='Calculation(interval=5mm)')
ax.plot(x_, Gain_C1, 'k-.', label='Calculation(interval=30mm)')
ax.plot(x_, Gain_C2, 'k-', label='Calculation(interval=60mm)')
ax.plot(x_, Gain_C3, 'k:', label='Calculation(interval=90mm)')
...
#ax.set_xticks(x_)
#ax.set_xticklabels(x_ticks, fontsize=16, rotation = 0)
