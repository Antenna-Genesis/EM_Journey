...
7. 独立思考，切忌人云亦云。以事实/常识为出发点，形成逻辑上讲得通的观点。杜绝说“别人这样，所以我也这样”。也请注意，观点随时间改变是常态，不必“捍卫”之前的想法；
...
1. 如无特殊情况，按时参加组会（现场和线上）。遇到不能参加或者迟到的情况，需在群组中向大家说明，否则算缺勤；
2. 从大四毕设开始，组会上定期介绍自己的研究或者学习进展（随着团队成长，无法每人每周都做）。大四毕设阶段本科生和硕士研究生必做，哪怕只有一页ppt也要报告，无特殊情况不可跳过；
3. 报告要有逻辑，不能意识流输出。建议的报告内容：当前在研究什么主题，报告前在尝试解决什么问题，自己的分析思路和解决方案，验证方法和结果，当前结论，下一步的计划；
4. 硕士的组会报告用英文写，可以汉语讲；
5. 限制时间，每人在5分钟之内讲完。内容实在多的话，等其他人都讲完展开；
6. 常规组会分两个环节：第一部分，本科生（毕设学生为主）介绍学习/研究进展、问题、复现工作等，讨论可能的解决办法；第二部分，硕士研究生介绍当周的工作和进展、以及接下来的预期工作。讲完的可以先走，不过鼓励听完；
7. 常规组会的两个环节之外，可以事先安排一些偶发性长时段内容。比如学术会议彩排，答辩彩排，项目阶段性报告（一般是加工前组内评议）等；
8. 考虑到经常有新人加入，不定期做自我介绍：家乡在哪里？有几个兄弟姐妹？经历过什么挑战？个人爱好？讲一个笑话（别人不笑很正常）。
## 课题
...
2. 来去自由，欢迎本科生进组体验。对进组体验的同学，不说不做的静默体验期一般为1个月（最多不超过2个月），之后要上手做研究，并在组会上讲进展和问题（新加入的研究生没有静默期）；
